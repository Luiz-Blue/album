...
class SuperHeroView {
    ...
    private JButton addImageButton, addVideoButton;
    private JList<SuperHero> heroList;
    private JLabel imageLabel;
    private JPanel videoPanel;
    private JFXPanel jfxPanel;
    private JLabel descriptionLabel; 
    private String imagePath; // ta aqui para nao bugar 
    private String videoPath; // ta aqui para não bugar
    ...
    public SuperHeroView() {
        ...
        addImageButton = new JButton("Adicionar Imagem"); // Botão para adicionar imagem
        addVideoButton = new JButton("Adicionar Vídeo"); // Botão para adicionar vídeo
        ...
        buttonPanel.add(addImageButton); // Adiciona o botão de imagem
        buttonPanel.add(addVideoButton); // Adiciona o botão de vídeo
        ...
        frame.add(jfxPanel, BorderLayout.SOUTH); // Adiciona o JFXPanel ao frame
...
//    public void setVideoPanel(JPanel panel) { videoPanel.removeAll(); videoPanel.add(panel); videoPanel.revalidate(); videoPanel.repaint(); }
    ...
    public int getSelectedHeroIndex() {
        return heroList.getSelectedIndex();
    }
    ...
    // Novos métodos para adicionar listeners aos novos botões
    ...
    // Método para obter o frame (para JFileChooser)
